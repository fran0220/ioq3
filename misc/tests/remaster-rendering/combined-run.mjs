...
try {
    ...
    await b.command('devmap q3dm1'); await ready();
    ...
    for (const hdr of [0,1]) {
        ...
        await b.command('cg_thirdPersonAngle 180'); await b.command('cg_thirdPersonRange 100');
        await b.command('setviewpos 1130 450 24 90');
        ...
        await b.command('give all'); await b.command('weapon 5');
        ...
        await b.command('+attack'); await sleep(200); await capture('rocket-firing-hdr' + hdr);
        await b.command('-attack'); await sleep(700); await capture('rocket-impact-hdr' + hdr);
