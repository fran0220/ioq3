...
class IconPackageTests(unittest.TestCase):
    def test_reproducible_texture_only_package_and_sources(self):
    ...
    def test_actual_vfs_coverage_alpha_and_distinct_semantics(self):
        with zipfile.ZipFile(ROOT / "ui-icons-v1.pk3") as archive:
            ...
            self.assertTrue(all(path.endswith((".tga", ".jpg")) for path in paths))
            ...
            for path in paths:
                ...
                if path.endswith(".tga"):
                    ...
                    self.assertGreater(sum(value > 128 for value in alpha.getdata()), 300, path)
